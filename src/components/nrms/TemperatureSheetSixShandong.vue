      ...
      <div style="margin: auto; position: relative; width: 750px">
        ...
        <table class="tableSvg" style="width: 750px">
          ...
          <tr class="height">
            ...
            <td rowspan="5" class="text-top" style="border-right-color: transparent; text-align: left">107.6°</td>
          ...
          <tr class="height">
            ...
            <td rowspan="5" class="text-top" style="border-right-color: transparent; text-align: left">105.8°</td>
          ...
          <tr class="height">
            ...
            <td rowspan="5" class="text-top" style="border-right-color: transparent; text-align: left">104°</td>
          ...
          <tr class="height">
            ...
            <td rowspan="5" class="text-top" style="border-right-color: transparent; text-align: left">102.2°</td>
          ...
          <tr class="height">
            ...
            <td rowspan="5" class="text-top" style="border-right-color: transparent; text-align: left">100.4°</td>
          ...
          <tr class="height">
            ...
            <td rowspan="5" class="text-top" style="border-right-color: transparent; text-align: left">90°</td>
          ...
          <tr class="height">
            ...
            <td rowspan="5" class="text-top" style="border-right-color: transparent; text-align: left">96.6°</td>
          ...
          <tr class="height">
            ...
            <td rowspan="5" class="text-top" style="border-right-color: transparent; text-align: left">95°</td>
          ...
          <template v-for="item in showSignItem">
            <tr :key="item.signId">
              <td :class="{every: true, hx: item.signItemFieldName==='huxi'}" colspan="4">
              ...
              <template v-else-if="item.signItemFieldName === 'xueya'">
                <template v-if="item.data[n - 1]" v-for="n in item.length">
                  <td :colspan="item.colspan" :class="{every: true, text_scale: item.data[n - 1].signValue.includes('下')}" >
          ...
          <svg :width="svgWidth + 'px'" :height="svgHeight + 'px'">
            ...
            <template v-for="(item, index) in ttPoint">
              <a-tooltip :title="item.title" :key="'ttPoint-'+ index">
                <use xlink:href="#icon-shixinsanjiao" width="10" height="10" :x="item.x - 5" fill='red' :y="item.y - 5"></use>
              </a-tooltip>
            </template>
            ...
            <template v-for="(item, index) in fcttPoint">
              <a-tooltip :title="item.title" :key="'fcttPoint-'+ index">
                <use xlink:href="#icon-kongxinsanjiao" width="10" height="10" :x="item.x - 5" fill='red' :y="item.y - 5"></use>
              </a-tooltip>
            </template>
