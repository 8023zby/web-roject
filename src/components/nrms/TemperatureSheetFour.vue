<template>
  <div class="temperature_sheet_print_container" id="temperature_sheet_print_container">
    ...
    -->
    <div>
      <div style="margin: auto; position: relative; width: 726px">
        <!-- svgIcon -->
        <svgIcon/>

        <!-- 体温单表格 -->
        <table class="tableSvg" style="width: 706px;">
          <colgroup>
            <col width="59px">
            <col width="59px">
            <!--周一-->
          ...
          <tr>
            ...
            <td colspan="4" class="every" v-for="i in 7">{{newCurWeekDate[i - 1] || ""}}</td>
          </tr>
          ...
          <tr>
            ...
            <td colspan="4" class="every" v-for="i in 7">{{curWeekDays.allSsDays[i - 1]}}</td>
          </tr>
          ...
          <tr class="height hour">
            ...
            <template v-for="i in 7">
              <template v-if="hours.length === 0">
                <td class="borderB" v-for="n in 4" :class="{borderR : n === 4 && i !== 7}"></td>
              </template>
              <template v-else>
                <td class="borderB" v-for="(h, index) in hours"
          ...
          <tr class="height">
            ...
            <td rowspan="5" class="borderRB text-top">41°</td>
            <td></td>
            <td></td>
            <td></td>
            <td class="borderR"></td>
          ...
          <tr class="height">
            ...
            <td rowspan="5" class="borderRB text-top">40°</td>
            <td></td>
            <td></td>
            <td></td>
            <td class="borderR"></td>
          ...
          <tr class="height">
            ...
            <td rowspan="5" class="borderRB text-top">39°</td>
            <td></td>
            <td></td>
            <td></td>
            <td class="borderR"></td>
          ...
          <tr class="height">
            ...
            <td rowspan="5" class="borderRB text-top">38°</td>
            <td></td>
            <td></td>
            <td></td>
            <td class="borderR"></td>
          ...
          <tr class="height">
            ...
            <td rowspan="5" class="borderRB text-top">37°</td>
            <td></td>
            <td></td>
            <td></td>
            <td class="borderR"></td>
          ...
          <tr class="height">
            ...
            <td rowspan="5" class="borderRB text-top">36°</td>
            <td></td>
            <td></td>
            <td></td>
            <td class="borderR"></td>
          ...
          <tr class="height">
            ...
            <td rowspan="5" class="borderRB text-top">35°</td>
            <td></td>
            <td></td>
            <td></td>
            <td class="borderR"></td>
...
export default {
  ...
  props: ['formHeader', 'patient', 'sheetData', 'signItem', 'curWeekDate', 'curWeekIn', 'curWeekDays', 'hours', 'curWeekIndex'],
  ...
  methods: {
    ...
    parseEvent (evenArray, beginDate) {
      ...
      const daysW = _this.td.width * 4 // 一天的显示的宽度
