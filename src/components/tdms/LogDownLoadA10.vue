<template>
  <div style="width: 100%;height: 100%">
      <el-form class="typt-add-dialog" ref="logForm" label-width="100px" :rules="rules" :model="form">
...
export default {
  ...
  data () {
    return {
      rules: {
        logDate: [
          { required: true, trigger: 'change', message: '请选择日志日期' }
        ],
        logType: [
          { required: true, trigger: 'change', message: '请选择日志类型' }
        ],
        startTime: [
