<template>
  <div class="passport-imgUpload">
    <span class="passport-add-img_span" style>{{imageObj.imglable ||''}}</span>
    <el-upload
      :class="{ 'avatar-uploader': true, 'passport-uploader-img': imageObj.imageUrl}"
    ...
    >
      ...
      <div v-else class="passport-add-img">上传图片</div>
    </el-upload>

    <el-dialog :visible.sync="dialogVisible" class="passport-imgDialog">
      <img
        :src="imageObj.imageUrl"
        style="max-width: 100%;max-height: 600px; padding-bottom: 20px;"
      />
    </el-dialog>
  </div>
</template>
