      ...
      <div class="comp-tr-node" slot-scope="{ node, data }">
        ...
        <template v-else>
          ...
          <span class="comp-tr-node--btns">
            <!-- 新增 -->
            <span style="margin:0px 13px 0 13px" @click="handleAdd(node, data)">
              <i class="el-icon-plus"></i>
            </span>

            <!-- 编辑 -->
            <span style="margin:0 13px 0 0" @click="handleEdit(node, data)">
              <i class="el-icon-edit"></i>
            </span>
            <!-- 删除 -->

            <span style="margin:0 13px 0 0" @click="handleDelete(node, data)">
