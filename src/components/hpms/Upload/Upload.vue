<template>
  <div class="custom-upload">
    ...
    />
    <div v-if="imageUrl===''" class="add" @click="handleOpenFile" style="text-align: center;line-height: 195px;">选择封面图</div>

    <div v-else class="upImage_div">
       <img  :src="imageUrl" class="upImages" />
       <div class="img_close">
          <i class="el-icon-close icon"   @click="closeImg" ></i>
        </div>
       <div class="edit">
        <span class="edit_Image"  @click="handleOpenFile">
          修改
        </span>
       </div>
