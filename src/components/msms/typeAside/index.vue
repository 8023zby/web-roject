<template>
  <div class="container typeaside">
    <div class="type-tit">{{activeTit}}分类</div>
    <div class="type-btn-group">
      <el-button @click="addType()" type="primary" size="small">添加分类</el-button>
      <el-button @click="sortType()" type="primary" size="small" style="float: right;">排序</el-button>
    </div>
    <!--<div-->
        <!--class="all-type-btn"-->
        <!--@click="spreadClick()"-->
    ...
    <transition name="fade">
      <div v-if="activeAllType" style="overflow: auto;height: 82%;">
