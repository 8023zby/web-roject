 ...
 * @Author: 刘慧
 * @Owner: 刘慧
 * @Date: 2022-08-18 18:10:14
 * @LastEditTime: 2022-08-18 18:10:15
 * @LastEditors: 刘慧
 * @Description: 
 * @FilePath: \yarward-ecms-frontend\src\components\ecms\PaginationTable.vue
-->
<template>
  <div style="height: 100%;display: flex;flex-direction: column;">
    ...
    <div class="paginationDiv">
      <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="paginations.pageIndex" :page-sizes="paginations.pageSizes" :page-size="paginations.pageSize" :layout="paginations.layout"
