    ...
    <div slot="main" class="add-from">
      <el-form v-uni="'hulibiaoqiantianjiabiaodan'" :model="ruleForm" :rules="rules" ref="ruleForm" label-width="auto" label-suffix=":">
        <el-form-item label="标签分类" prop="classId">
          <el-select v-model="ruleForm.classId" filterable multiple disabled clearable placeholder="请选择" v-uni="'classId'">
            <el-option v-for="item in classify_data" :key="item.classId" :label="item.className" :value="item.classId">
            </el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="科室标签名称" prop="deptLabelName">
          <el-input v-model.trim="ruleForm.deptLabelName" placeholder="请输入" oninput="if(value.length>16)value=value.slice(0,16)"></el-input>
        </el-form-item>
        <el-form-item label="是否手工输入" prop="inputType">
          <el-radio-group v-model="ruleForm.inputType" disabled @change="handleInputType">
            <el-radio :label="1">是</el-radio>
            <el-radio :label="2">否</el-radio>
          </el-radio-group>
        </el-form-item>
        <el-form-item label="显示标识" prop="identifyId">
          <el-select v-model="ruleForm.identifyId" v-uni="'identifyId'" filterable disabled clearable placeholder="请选择">
        ...
        <el-form-item label="关联内容" prop="dataSources">
          <el-radio-group v-model="ruleForm.dataSources" disabled @change="handleRelationType">
        ...
        <el-form-item label="关联患者字段" prop="relationField" v-if="ruleForm.dataSources === 1" style="width: 725px">
          <el-col :span="12">
            <el-select v-model="ruleForm.relationField" v-uni="'relationField'" disabled filterable clearable placeholder="请选择" @change="handlerPatientChange" style="width: 300px">
              <el-option v-for="item in patient_data" :key="item.labelId" :label="item.labelName" :value="item.labelSql">
              </el-option>
            </el-select>
          </el-col>
          <el-col :span="10" :offset="2">
            <el-select v-model="ruleForm.relationValue" v-uni="'relationValue'" filterable disabled clearable placeholder="请选择" style="width: 300px">
        ...
        <el-form-item label="关联风险评估" prop="relationField" v-if="ruleForm.dataSources === 2" style="width: 725px">
          <el-col :span="12">
            <el-select v-model="ruleForm.relationField" v-uni="'relationField'" filterable disabled clearable placeholder="请选择" @change="handlerAssessChange" style="width: 300px">
        ...
        <el-form-item label="字段内容" prop="labelSql" v-if="ruleForm.dataSources === 3" disabled>
          <el-input v-model="ruleForm.labelSql" placeholder="请输入" disabled></el-input>
        </el-form-item>
        <el-form-item label="脚本内容" prop="labelSql" v-if="ruleForm.dataSources === 4" disabled>
          <el-input type="textarea" :rows="5" v-model="ruleForm.labelSql" placeholder="请输入" disabled></el-input>
        </el-form-item>
        <el-form-item label="正则表达式" v-if="ruleForm.dataSources === 5">
          <el-input type="textarea" :rows="5" v-model="ruleForm.labelMatchAdviceRegular" placeholder="请输入">
          </el-input>
        </el-form-item>

        <el-form-item label="正则表达式" v-if="ruleForm.dataSources === 6">
          <el-input type="textarea" :rows="5" v-model="ruleForm.labelMatchAdviceAssistRegular" placeholder="请输入"></el-input>
        </el-form-item>
        <el-form-item label="信息看板显示样式" prop="boardShowValue">
          <el-checkbox-group v-model="ruleForm.boardShowValue" @change="changeBoardShowValue" disabled class="display-checkbox">
            <el-checkbox label="1">
              <div class="checkbox-label">
                ...
                <div class="checkbox-color" @click.stop.prevent="() => {}">
                  ...
                  <el-color-picker v-model="color1" disabled size="mini" @change="changeColor(1)"></el-color-picker>
                </div>
                <div class="checkbox-color" @click.stop.prevent="() => {}">
            ...
            <el-checkbox label="2">
              <div class="checkbox-label">
                ...
                <div class="checkbox-color" @click.stop.prevent="() => {}">
                  <span class="checkbox-color-label">字体颜色：</span>
                  <el-color-picker v-model="color2" disabled size="mini" @change="changeColor(2)"></el-color-picker>
                </div>
                <div class="checkbox-color" @click.stop.prevent="() => {}">
            ...
            <el-checkbox label="3">
              <div class="checkbox-label">
                ...
                <div class="checkbox-color" @click.stop.prevent="() => {}">
                  <span class="checkbox-color-label">字体颜色：</span>
                  <el-color-picker v-model="color3" disabled size="mini" @change="changeColor(3)"></el-color-picker>
                </div>
                <div class="checkbox-color" @click.stop.prevent="() => {}">
            ...
            <el-checkbox label="4" :disabled="isRelationCheckBoxDisabled">
              <div class="checkbox-label">
                ...
                <div class="checkbox-color" @click.stop.prevent="() => {}">
                  <span class="checkbox-color-label">字体颜色：</span>
                  <el-color-picker v-model="color4" disabled size="mini" @change="changeColor(4)"></el-color-picker>
                </div>
                <div class="checkbox-color" @click.stop.prevent="() => {}">
                ...
                <div class="checkbox-relation" @click.stop.prevent="() => {}">
                  <el-form-item label="" v-uni="'checkboxrelation'" prop="relation">
                    ...
                    <el-select v-model="relation" disabled v-uni="'checkboxrelationselect'" filterable :disabled="isRelationDisabled" placeholder="请选择" style="width: 300px">
                      <el-option v-for="item in patient_data" :key="item.labelId" :label="item.labelName" :value="item.labelSql">
                      </el-option>
                    </el-select>
                  </el-form-item>
        ...
        <el-form-item label="信息看板是否显示执行状态" prop="isShowStatus">
          <el-radio-group v-model="ruleForm.isShowStatus" disabled @change="handleIsShowStatus">
            <el-radio :label="1">是</el-radio>
            <el-radio :label="0">否</el-radio>
          </el-radio-group>
        </el-form-item>
        <el-form-item label="信息看板状态是否允许手输" prop="boardUpdate">
          <el-radio-group v-model="ruleForm.boardUpdate" disabled>
            <el-radio :label="1">是</el-radio>
            <el-radio :label="0">否</el-radio>
          </el-radio-group>
        </el-form-item>
...
import {
  ...
  ApiPatientManage,
  ApiNurseLevel,
  ApiNursingUsedManage,
} from "../../../api/bnms/index";
import layout from "../../../components/bnms/layout/edit";
// import data2blob from "../../../components/pcms/ImageCropper/utils/data2blob";
...
export default {
  ...
  data() {
    return {
      ...
      assess_child_data: [],
      ruleForm: {
        labelMatchAdviceAssistRegular: "",
        labelMatchAdviceRegular: "",
        deptLabelName: "",
        classId: [],
        identifyId: "",
        dataSources: 1,
      ...
      rules: {
        deptLabelName: [
          { required: true, message: "请输入科室标签名称！", trigger: "blur" },
          {
            min: 1,
            max: 20,
  ...
  created() {
    let usedId = this.$route.query.usedId || {};

    this.getDetail(usedId);
    this.getClassify();
  },
  methods: {
    changeColor(item) {
    ...
    getDetail(id) {
      ApiNursingUsedManage.detail({ usedId: id })
        .then((res) => {
          if (res.status == 200) {
            var data = res.data;
            this.parseDetail(data);
          }
          // const res = {
          //   bnLabelDictDo: {
          //     labelId: "6ee7e5dc8f134cc38aaec2db3b799d15",
          //     labelType: 201,
          //     labelName: "压力性损伤：≤9分",
          //     inputType: 2,
          //     dataSources: 1,
          //     relationField: "patientName",
          //     relationValue: "",
          //     relationWarn: null,
          //     identifyId: "",
          //     labelShowType: 0,
          ...
          //     labelEvent: null,
          //     labelSql: "",
          //     classId: "a51932a4845f484683ae22da80ad97e7",
          //     boardShowValue: '{"1":"#555555","2":"#555555","3":"#555555"}',
          //   },
          //   labelMatchAdviceRegular: "", // 医嘱正则
          //   labelMatchAdviceAssistRegular: "", // 医嘱辅助正则
          //   positionList: "",
          // };
        })
        .catch((e) => {
    ...
    parseDetail(data) {
      let detail = data.bnLabelDictDo;

      if (detail.classId && typeof detail.classId === "string") {
        detail.classId = detail.classId.split(",");
      } else {
        detail.classId = [];
      }
      if (detail.dataSources && detail.dataSources !== 1) {
        this.relation = "";
        this.isRelationDisabled = true;
        this.isRelationCheckBoxDisabled = true;
      }
      if (detail.boardShowValue) {
        try {
          let obj = JSON.parse(detail.boardShowValue);
          detail.boardShowValue = [];
          Object.keys(obj).map((item) => {
            detail.boardShowValue.push(item);
            switch (item) {
              case "4":
          ...
          console.log(error);
          detail.boardShowValue = detail.boardShowValue.split(",");
        }
      } else {
        detail.boardShowValue = [];
      }
      Object.assign(this.ruleForm, detail, {
        usedId: data.usedId,
        labelMatchAdviceRegular: data.labelMatchAdviceRegular,
        labelMatchAdviceAssistRegular: data.labelMatchAdviceAssistRegular,
        deptLabelName: data.deptLabelName,
      });
    },
    getClassify() {
      Promise.all([
    ...
    submitForm() {
      ...
      this.$refs.ruleForm.validate((valid) => {
        if (valid) {
          const params = {
            usedId: this.ruleForm.usedId,
            labelId: this.ruleForm.labelId,
            deptId: this.deptInfo.deptId,
            orgId: this.deptInfo.orgId,
            labelType: this.ruleForm.labelType,
            deptLabelName: this.ruleForm.deptLabelName,
            labelMatchAdviceRegular: this.ruleForm.labelMatchAdviceRegular,
            labelMatchAdviceAssistRegular:
              this.ruleForm.labelMatchAdviceAssistRegular,
          };
          ApiNursingUsedManage.custom(params)
            .then(() => {
