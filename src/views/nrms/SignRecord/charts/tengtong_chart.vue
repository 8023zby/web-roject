<template>
      <LayoutList>
        ...
        <div id="tengtong_chart_container" style="margin: 38px auto 0;" :style="chartStyle"></div>
      </div>
        </div>
      </LayoutList>
</template>
  ...
  export default {
    ...
    mounted () {
      ...
      this.$nextTick(function () {
        this.drawPie('tengtong_chart_container')
      })
    },
    watch: {
      patient: {
