  ...
  <layout>
    ...
    <div slot="main" class="right">
      <!-- <el-tabs :value="activeName" type="card" @tab-click="handleClick" style="width: 100%">
        ...
        <el-tab-pane label="简版医嘱" name="thired" style="overflow: auto">
          <jane-version :patient="patient" :patientType="patientType" />
        </el-tab-pane>
      </el-tabs> -->
      <list :patient="patient" :patientType="patientType" />
    </div>
  </layout>
</template>
...
export default {
  ...
  components: {
    ...
    // janeVersion: () => import('./janeVersion/Main')
  }
}
</script>
