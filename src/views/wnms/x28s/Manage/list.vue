  ...
  <div class="typt-list-container">
    ...
    <div>
      ...
      <div class="typt-list-add-div">
        <el-button type="warning" icon="el-icon-plus" @click="$emit('option-changed','addorEdit',{type:'add',selectDeptId:selectDeptId})">新建</el-button>
    ...
    <el-table :data="pagination.list" style="width: 100%" height="80%" select-all stripe>
      ...
      <el-table-column label="是否轮播" prop="isLoop" align="center">
        <template slot-scope="scope">
          <el-switch :active-value="1" :inactive-value="0" @change="changeSwitch(scope.row)" v-model="scope.row.isLoop"></el-switch>
        </template>
      </el-table-column>
      ...
      <el-table-column label="操作" align="center">
        <template slot-scope="scope">
          ...
          <span class="el-button-text-color" @click="$emit('option-changed','addorEdit', {type:'edit',row:scope.row})">编辑</span>
    ...
    <el-dialog :visible.sync="dialogSortVisible" width="500px">
      ...
      <el-table ref="dragTable" :data="tableSortData" style="width: 100%" max-height="500" row-key="screenId" fit highlight-current-row>
...
import tempNumView from "./template/tempNumView";
