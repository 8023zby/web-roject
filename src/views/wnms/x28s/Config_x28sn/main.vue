  ...
  <el-container>
    <el-main>
      <el-form ref="configContent" :model="configContent" :rules="rules" label-width="160px">
        <el-form-item label="科室:" style="width:30%" v-if="deviceId==''">
        ...
        <el-form-item label="未处理呼叫提醒">
          <el-radio v-model="configContent.notCalldRemind" label="1">持续提醒</el-radio>
          <el-radio v-model="configContent.notCalldRemind" label="2">间隔提醒</el-radio>
        </el-form-item>
        ...
        <el-form-item label="定时重启" prop="name">
          <el-switch v-model="configContent.autoRestarScreen.state" :active-color="switchActiveColor" :active-value="true" :inactive-value="false" />每天
          <el-time-picker v-model="configContent.autoRestarScreen.time" format="HH:mm:ss" value-format="HH:mm:ss" :clearable="false" :disabled="!configContent.autoRestarScreen.state" class="w120" />时间，自动重启
        </el-form-item>
      </el-form>
