...
<template>
  <el-container class="edit-page-new">
    <el-header :height="'48px'">
      <!--标题-->
      <div class="title">
        <slot name="title">{{ detail.type==="add"?'添加':'修改' }}</slot>
      </div>
      <!--头部右侧按钮-->
      <div class="right-btn">
    ...
    <el-main>
      ...
      <slot name="main">
        <el-form ref="form" :model="form" :rules="rules" label-width="150px">
          <el-form-item label="护理单元:" prop="deptIdList">
            <el-select
          ...
          <el-form-item el-form-item label="接收设备:" prop="bedDivice">
...
export default {
  ...
  methods: {
    ...
    Save (form) {
      ...
      // 接收设备
      let d = [...diviceArr]
      if (d.indexOf('bnPDA') >= 0) d.push('wnMedicalAudioAssistant')
