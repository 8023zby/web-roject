<template>
  <div class="typt-list-main">
    <div class="typt-tit-cls"
      ...
      <div class="typt-tit-content">{{titMsg}}层级</div>
    </div>
    <div class="">
      <div class="typt-add-form">
        <el-form :model="addFormData"
          ...
          <el-form-item label="层级名称："
                        prop="hierarchyName">
            <el-input v-model="addFormData.hierarchyName"
          ...
          <el-form-item label="层级描述："
            ...
            <el-input v-model="addFormData.hierarchyDescribe"
                      rows="7"
                      style="width: 300px;"
                      autocomplete="off"
                      type="textarea"
...
export default {
  ...
  data () {
    return {
      ...
      rules: {
        hierarchyName: [
          // { required: true, message: '层级名称长度不超过10个字符！', trigger: 'blur', pattern: /^.{1,10}$/ }
        ],
        hierarchyDescribe: [
          // { message: '层级描述长度不超过200个字符！', trigger: 'blur', pattern: /^.{0,200}$/ }
        ]
      }
    }
  },
