<template>
  ...
  <div class="typt-list-container"
    ...
    <el-form  :inline="true"
      ...
      <el-form-item>
        <div class="typt-search-btn">
          ...
          v-uni="'ysyuepaiban_edit_search'"
                     icon="el-icon-search" @click="onSearchSubmit" size="small">
            搜索
          </el-button>
          <el-button v-uni="'ysyuepaiban_edit_reset'" type="text" @click="reloadMain">重置</el-button>
        </div>
      </el-form-item>
    </el-form>
    ...
    <div v-show="selectShow" slot="footer" class="dialog-footer btnDiv" style="height: 50px;margin-bottom: 10px;">
      <el-button v-uni="'ysyuepaiban_edit_cancel'" @click="refresh" style="width: 70px;height: 40px;">取消</el-button>
      <el-button v-uni="'ysyuepaiban_edit_save'" type="primary" @click="saveData" style="width: 70px;height: 40px;">保存</el-button>
    </div>
