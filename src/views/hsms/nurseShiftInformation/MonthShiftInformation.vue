<template>
  ...
  <div class="typt-list-container" v-loading="loading">
      ...
      <el-form-item>
        <div class="typt-search-btn">
          <el-button type="primary" class="el-button-radius shift-search"
                     icon="el-icon-search" v-uni="'hushiyuepaiban_search'" @click="onSearchSubmit" size="small">搜索
          </el-button>
          <el-button type="text" v-uni="'hushiyuepaiban_reset'" @click="reloadMain">重置</el-button>
        </div>
      </el-form-item>
    </el-form>
    <hr/>
      ...
      <div class="action_div">
        <el-button-group>
          <el-button class="shift-search"
                     ...
                     type="primary" size="small"  v-uni="'hushiyuepaiban_setting'" @click="showSet()">设置
          </el-button>
          <el-button class="shift-button" type="primary"  v-uni="'hushiyuepaiban_edit'" size="small" @click="showSetMonth()">编辑排班</el-button>
          <!--<el-button type="primary" size="small" @click="printData()">打印</el-button>-->
          <el-button class="shift-button" v-if="exportDesc" type="primary" v-uni="'hushiyuepaiban_export'" size="small" @click="exportDo()" disabled>导出</el-button>
          <el-button class="shift-button" v-if="!exportDesc" type="primary" v-uni="'hushiyuepaiban_export2'"  size="small" @click="exportDo()">导出</el-button>
        </el-button-group>
        <div class="model_cls"
    ...
    <div v-show="selectShow" slot="footer" class="dialog-footer btnDiv">
      <el-button v-uni="'hushiyuepaiban_cancel'" @click="refresh">取消</el-button>
      <el-button v-uni="'hushiyuepaiban_save'" type="primary" @click="saveData">确认</el-button>
    </div>
    ...
    <el-dialog title="设置" :visible.sync="setParam.setFormVisible"
      ...
      <div slot="footer" class="dialog-footer"
        ...
        <el-button v-uni="'hushiyuepaiban_setting_cancel'" @click="cancelSetAdd">取消</el-button>
        <el-button v-uni="'hushiyuepaiban_setting_save'" type="primary" @click="saveSetData" :loading="addVis">确认</el-button>
      </div>
    </el-dialog>
    <!--end-->
  </div>
