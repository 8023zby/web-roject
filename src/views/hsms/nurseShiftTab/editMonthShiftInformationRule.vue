<template>
  ...
  <div class="typt-list-container" v-loading="loading">
    ...
    <div v-show="selectShow" slot="footer" class="dialog-footer btnDiv" style="height: 50px;">
      <el-button @click="refresh" style="width: 70px;height: 40px;" v-uni="'yihuyuepaibanguize_cancel'">取消</el-button>
      <el-button type="primary" @click="saveData" :loading="addVis" style="width: 70px;height: 40px;" v-uni="'yihuyuepaibanguize_save'">保存</el-button>
    </div>
