<template>
  <div class="typt-list-container" style="overflow: hidden;">
    <el-tabs v-model="activeName" class="hsms-shift-tab" @tab-click="handleClick" type="card" style="height: 100%;">
...
import nurseShiftInformationRule from "../nurseShiftInformationRule/ShiftInformationRule";
import nurseMonthShiftInformationRule from "../nurseShiftInformationRule/MonthShiftInformationRule";
import nurseShiftInformation from "../nurseShiftInformation/ShiftInformation";
import nurseMonthShiftInformation from "../nurseShiftInformation/MonthShiftInformation";
