<template>
    ...
    <div class="typt-list-container">
        ...
        <div v-show="selectShow" slot="footer" class="dialog-footer btnDiv">
            <el-button v-uni="'hushipaibanguize_cancel'" @click="refresh">取消</el-button>
            <el-button v-uni="'hushipaibanguize_save'" type="primary" @click="saveData" :loading="addVis">保存</el-button>
        </div>
        <!--设置-->
        <el-dialog title="设置"
            ...
            <div slot="footer" class="dialog-footer"
                ...
                <el-button @click="cancelSetAdd" v-uni="'hushipaibanguize_setting_cancel'">取消</el-button>
                <el-button type="primary" @click="saveSetData" :loading="addVis" v-uni="'hushipaibanguize_setting_save'">确认</el-button>
            </div>
        </el-dialog>
        <!--end-->
    </div>
