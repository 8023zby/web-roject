<template>
  ...
  <div class="typt-list-container" v-loading="loading">
    <div class="typt-list-add-div" style="padding-bottom: 13px;">
      <div class="action_div">
        <el-button v-if="formSearchData.businessType == 'DOCTOR'"
                   v-uni="'hushiyuepaibanguize_setting'"
                   class="shift-button"
                   style="padding: 6px 0 !important;"
                   type="primary"
                   size="small" @click="showSet()">设置
        </el-button>
        <el-button class="shift-button"
                   v-uni="'hushiyuepaibanguize_edit'"
                   style="padding: 6px 0 !important;"
                   type="primary" size="small" @click="setDutyMonth()">编辑排班</el-button>
        <div class="model_cls"
    ...
    <div v-show="selectShow" slot="footer" class="dialog-footer btnDiv">
      <el-button v-uni="'hushiyuepaibanguize_cancel'" @click="refresh">取消</el-button>
      <el-button v-uni="'hushiyuepaibanguize_save'" type="primary" @click="saveData" :loading="addVis">保存</el-button>
    </div>
    ...
    <el-dialog title="设置"
      ...
      <div slot="footer" class="dialog-footer"
        ...
        <el-button v-uni="'hushiyuepaibanguize_setting_cancel'" @click="cancelSetAdd">取消</el-button>
        <el-button v-uni="'hushiyuepaibanguize_setting_save'" type="primary" @click="saveSetData" :loading="addVis">确认</el-button>
      </div>
    </el-dialog>
    <!--end-->
  </div>
