          ...
          <el-tab-pane label="转科" name="trans">
            ...
            >
              <el-table-column
                ...
                width="79px"
              ></el-table-column>
              <el-table-column prop="patientName" label="姓名" show-overflow-tooltip width="100px"></el-table-column>
            </el-table>
          </el-tab-pane>
          <el-tab-pane label="出院" name="out">
            ...
            >
              <el-table-column
                ...
                width="79px"
              ></el-table-column>
              <el-table-column prop="patientName" label="姓名" show-overflow-tooltip width="100px">
  ...
  data () {
    return {
      ...
      table_height:
        ...
        33 -
        36 -
        (this.$route.meta.isFullScreen ? 0 : 40),
      activeName: 'in',
      inList: [],
      outList: [],
      transList: [],
  ...
  methods: {
    selectPatientData () {
      ApiPatient.selectIn().then(res => {
        this.inList =
          res.data && res.data.patientSelectDtos
            ? res.data.patientSelectDtos
            : []
        this.$nextTick(function () {
          if (
            this.$refs.inTable &&
            this.initRowType === 'in' &&
            this.inList[this.initRowIndex]
          ) {
            this.activeName = 'in'
      ...
      ApiPatient.selectOut().then(res => {
        ...
        this.$nextTick(function () {
          if (
            this.$refs.outTable &&
            this.initRowType === 'out' &&
            this.outList[this.initRowIndex]
          ) {
            this.activeName = 'out'
      ...
      ApiPatient.selectTrans().then(res => {
        ...
        this.$nextTick(function () {
          if (
            this.$refs.transTable &&
            this.initRowType === 'trans' &&
            this.transList[this.initRowIndex]
          ) {
            this.activeName = 'trans'
            this.$refs.transTable.setCurrentRow(
              this.transList[this.initRowIndex]
            )
...
.nrms_patient_list /deep/ .el-table--border::after,
