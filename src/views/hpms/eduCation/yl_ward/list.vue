  ...
  <div class="typt-list-main">
    <div class="typt-list-container">
      ...
      <div class="typt-list-add-div">
        <el-button type="warning" icon="el-icon-plus" @click="addShow(null,'AssortForm.Tform')">新建</el-button>
   ...
   <!-- 查询条件 -->
      <el-form :inline="true" class="demo-form-inline">
        ...
        <!-- <el-form-item v-if="detail.isWard===1" label="护理单元">
          <el-select v-model="search.nurseUnitId" placeholder="请选择">
            <el-option value>请选择</el-option>
            <el-option
              v-for="item in nurseUnitId"
              :key="item.value"
              :label="item.label"
              :value="item.value"
            />
      ...
      >
        ...
        <el-table-column label="文章分类" :formatter="contCategory" prop="categoryId" align="center" />
        <el-table-column
          v-if="detail.isWard ===1"
          label="护理单元"
          prop="nurseUnitId"
