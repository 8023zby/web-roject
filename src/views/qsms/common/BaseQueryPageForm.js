...
export default {
  ...
  methods: {
    ...
    createQueryParams () {
      ...
      // if (this.selectDeptInfo !== null && this.selectDeptInfo.deptId && this.selectDeptInfo.deptId !== null) this.search.nurseUnitId = this.selectDeptInfo.deptId
      var sh = {}
