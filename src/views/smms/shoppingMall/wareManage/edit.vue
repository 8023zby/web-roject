<template>
  <div class="typt-list-main">
    <div class="typt-tit-cls">
      ...
      <div class="typt-tit-content">编辑商品</div>
    </div>
    <div class="typt-add-container" v-loading="loading">
      <div class="typt-add-form" style="width:98rem">
        <el-form ref="form" :model="form" :rules="rules" label-width="120px">
          ...
          <el-form-item label="立即上架：" v-if="false">
            <el-switch v-model="form.shelfState" :inactive-value="0" :active-value="1" />
          </el-form-item>
        </el-form>
      </div>
      <div class="typt-add-footer">
        <el-button type="primary" @click="submitClick('form')">提交</el-button>
        ...
        <el-form-item label-width="90px">
          <div class="form-right">
            <el-form-item label="商品名称：">
              <el-input style="width:8rem" />
            </el-form-item>
            <el-form-item label="商品细分：" class>
              <el-input class="waretype" />
            </el-form-item>
            <el-form-item class="waretype">
              <el-input />
            </el-form-item>
            <el-form-item class="waretype">
              <el-input />
...
export default {
  ...
  created () {
    wareManageApi.Detail(this.detail.row.id).then(res => {
      const obj = []
      if (res.status === 200) {
        this.imgDataUrl = res.data.mainImage || ''
        //  特殊处理一下 其他项目可不用这个
